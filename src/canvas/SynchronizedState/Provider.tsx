...
const SynchronizedStateProvider: FunctionComponent<Props> = ({ children }: Props): JSX.Element => {
    // const {
    //     sessionId,
    //     roomId,
    //     isTeacher,
    ...
    const synchronizedStateProviderActions = {
        setDisplay: () => {null;}, // setDisplayAction,
        setLocalDisplay: setLocalDisplay,
        setPermissions: () => {null;}, // setPermissionsAction,
        getPermissions: () => createEmptyPermissions(), // getPermissionsAction,
